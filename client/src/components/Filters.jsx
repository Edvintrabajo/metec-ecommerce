const Filters = () => {
    return(
    <div id="filters" className="flex justify-center flex-wrap relative">
        
        <div id="burger-container" className=" w-full bg-slate-200 p-4 pl-8 flex leading-loose z-20 relative">
            <label htmlFor="burger" className="burger">
                <input id="burger" className="closed absolute" type="checkbox"/>
                <span></span>
                <span></span>
                <span></span>
            </label>
        ...
        <div id="filter-container" className="w-4/5 bg-white h-70 rounded-b-lg flex z-10 relative">
