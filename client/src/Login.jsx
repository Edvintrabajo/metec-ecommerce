...
function Login() {  
    return (
      <div className="bg-bg-img bg-center bg-cover p-4 w-full h-screen flex flex-col items-center justify-center">
        <form id="login-form" action="#" method="post" className="bg-transparent backdrop-blur-lg border-2 rounded-md flex justify-center items-start flex-wrap h-2/5 text-white tablet:text-xl laptop:w-3/5 laptop:h-3/5 desktop:text-2xl desktop:h-2/5 desktop:w-2/5">
